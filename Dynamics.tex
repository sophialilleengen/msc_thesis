...
\end{equation}
even if they are not perfect St\"ackel potentials. This method is called St\"ackel Fudge \citep{Binney...StaeckelFudge...2012}. This algorithm is implemented in \texttt{galpy} and we use is for the action calculations
