...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}llll@{}}
         ...
         %\midrule
         total & \makecell[tl]{sum of these\\ potentials} & \makecell[tl]{at R$_0$ = \SI{8.03}{kpc} \\ v$_{0,\mathrm{tot}}$ \SI{221.31}{km.s^{-1}}}& \makecell[tl]{R$_0$ is $1/3$ of the galaxy \\radius. v$_0$ is the sum of \\the fitted circular velocities.}\vspace{3mm}\\
         \bottomrule 
    \end{tabular}
